...
Area::~Area()
{
		...
		vector<const Animal*>::const_iterator itBeginWorker = animals.begin();
		vector<const Animal*>::const_iterator itEndWorker = animals.end();

		for (; itBeginWorker != itEndWorker; ++itBeginWorker)
			delete *itBeginWorker;
